...
export interface ResponseCreateMessageThreadsThreadIdMessagesPost {
  ...
  /**
   * The base64 encoded PDF data, without any prefixes like
   * `data:application/pdf;base64,`, for example:
...
export type ResponseCreateMessageThreadsThreadIdMessagesPostTypeEnum =
  (typeof ResponseCreateMessageThreadsThreadIdMessagesPostTypeEnum)[keyof typeof ResponseCreateMessageThreadsThreadIdMessagesPostTypeEnum];
...
export type ResponseCreateMessageThreadsThreadIdMessagesPostContentFormatEnum =
  (typeof ResponseCreateMessageThreadsThreadIdMessagesPostContentFormatEnum)[keyof typeof ResponseCreateMessageThreadsThreadIdMessagesPostContentFormatEnum];
...
export type ResponseCreateMessageThreadsThreadIdMessagesPostContentTypeEnum =
  (typeof ResponseCreateMessageThreadsThreadIdMessagesPostContentTypeEnum)[keyof typeof ResponseCreateMessageThreadsThreadIdMessagesPostContentTypeEnum];

/**
 * Check if a given object implements the
 * ResponseCreateMessageThreadsThreadIdMessagesPost interface.
 */
export function instanceOfResponseCreateMessageThreadsThreadIdMessagesPost(
  value: object
): value is ResponseCreateMessageThreadsThreadIdMessagesPost {
...
export function ResponseCreateMessageThreadsThreadIdMessagesPostFromJSON(
  json: any
): ResponseCreateMessageThreadsThreadIdMessagesPost {
  return ResponseCreateMessageThreadsThreadIdMessagesPostFromJSONTyped(
    json,
    false
  );
}

export function ResponseCreateMessageThreadsThreadIdMessagesPostFromJSONTyped(
  json: any,
...
export function ResponseCreateMessageThreadsThreadIdMessagesPostToJSON(
  json: any
): ResponseCreateMessageThreadsThreadIdMessagesPost {
  return ResponseCreateMessageThreadsThreadIdMessagesPostToJSONTyped(
    json,
    false
  );
}

export function ResponseCreateMessageThreadsThreadIdMessagesPostToJSONTyped(
  value?: ResponseCreateMessageThreadsThreadIdMessagesPost | null,
