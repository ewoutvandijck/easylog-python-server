...
export class MessagesApi extends runtime.BaseAPI {
     ...
     * Delete Message
     */
    async deleteMessageThreadsThreadIdMessagesMessageIdDeleteRaw(requestParameters: DeleteMessageThreadsThreadIdMessagesMessageIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['threadId'] == null) {
            throw new runtime.RequiredError(
                'threadId',
     ...
     * Delete Message
     */
    async deleteMessageThreadsThreadIdMessagesMessageIdDelete(requestParameters: DeleteMessageThreadsThreadIdMessagesMessageIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.deleteMessageThreadsThreadIdMessagesMessageIdDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Retrieves all messages for a given thread. Returns a list of all messages by default in descending chronological order (newest first).
     * Get Messages
     */
    async getMessagesThreadsThreadIdMessagesGetRaw(requestParameters: GetMessagesThreadsThreadIdMessagesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginationMessages>> {
        if (requestParameters['threadId'] == null) {
            throw new runtime.RequiredError(
                'threadId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginationMessagesFromJSON(jsonValue));
    }
     ...
     * Get Messages
     */
    async getMessagesThreadsThreadIdMessagesGet(requestParameters: GetMessagesThreadsThreadIdMessagesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginationMessages> {
        const response = await this.getMessagesThreadsThreadIdMessagesGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
export type GetMessagesThreadsThreadIdMessagesGetOrderEnum = typeof GetMessagesThreadsThreadIdMessagesGetOrderEnum[keyof typeof GetMessagesThreadsThreadIdMessagesGetOrderEnum];
