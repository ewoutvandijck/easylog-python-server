...
class KnowledgeGraphTools(BaseTools):
    def __init__(self, thread_id: str, entities: dict[str, type[BaseModel]] | None = None):
    ...
    async def tool_store_episode(self, conversation_summary: str, episode_body: str) -> str:
        ...
        return episode.episode.model_dump_json()
    ...
    async def tool_search_knowledge_base(self, query: str) -> str:
        ...
        results = await graphiti.search(query, group_ids=[self.thread_id])
