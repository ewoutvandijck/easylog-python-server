...
class OpenAIo1Config(AgentConfig):
    assistant_id: str


class OpenAIo1(BaseAgent):
    client: OpenAI
    ...
    async def on_message(
        self, messages: List[Message], config: OpenAIo1Config
        ...
        Args:
            ...
            config (OpenAIo1Config): The configuration for the assistant.
