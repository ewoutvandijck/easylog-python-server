...
class AnthropicNewConfig(BaseModel):
    subjects: list[Subject] = Field(
        default=[
            Subject(
                name="Algemeen",
                instructions="Je bent een vriendelijke en behulpzame technische assistent voor CAF TRAM monteurs. In dit onderwerp bespreek je het in dienst nemen van de tram op basis van de documentatie. Als er LET OP in de documentatie staat, dan deel deze informatie mee aan de monteur.",
